          ...
          child: BackdropFilter(
            ...
            child: Container(
              decoration: BoxDecoration(
                ...
                color: isDark
                    ? AppColor.bgPageDark.withOpacity(0.45)
              ...
              child: Padding(
                ...
                child: Row(
                  ...
                  children: [
                    Expanded(child: _buildNavItem(0, Icons.home, t.navHome)),
                    Expanded(
                      child: _buildNavItem(1, Icons.manage_search, t.navSearch),
                    ),
                    Expanded(
                      child: _buildNavItem(2, Icons.date_range, t.bronlarTitle),
                    ),
                    Expanded(
                      child: _buildNavItem(
                        3,
          ...
          children: [
            Container(
              ...
              decoration: BoxDecoration(
                ...
                color: isDark
                    ? (isSelected ? AppColor.bgBlogDark : Colors.transparent)
